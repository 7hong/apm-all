...
/**
 * Created by Jiang Qihong on 2018/3/30
 */
public final class DefaultMethodMetricsFormatter implements MethodMetricsFormatter {
    ...
    public String format(List<MethodMetrics> methodMetricsList, long startMillis, long stopMillis) {
        ...
        sb.append("apm Method Metrics [").append(DateFormatUtils.format(startMillis)).append(", ").append(DateFormatUtils.format(stopMillis)).append("]").append(String.format("%n"));
