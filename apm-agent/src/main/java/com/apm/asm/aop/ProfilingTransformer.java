...
/**
 * Created by Jiang Qihong on 2018/4/24
 */
public class ProfilingTransformer implements ClassFileTransformer {
    ...
    private boolean needComputeMaxs(ClassLoader classLoader) {
        ...
        return "org.apache.catalina.loader.WebappClassLoader".equals(loaderName) || "org.springframework.boot.loader.LaunchedURLClassLoader".equals(loaderName);
